  ...
  >
    <div class="container">
      <div class="row justify-content-md-center">
        ...
        <div class="text-center col-md-12 col-lg-8">
          <a
            href="https://www.creative-tim.com/product/vue-wiblog-tools"
      ...
      <div class="row text-center mt-5">
        <div class="col-md-8 ml-auto mr-auto">
          ...
          <h5 class="description">
            We've just launched
            <a
              href="http://demos.creative-tim.com/vue-wiblog-tools-pro"
              target="_blank"
      ...
      <div class="row justify-content-md-center sharing-area text-center">
        ...
        <div class="text-center col-md-12 col-lg-8">
          ...
          <a
            target="_blank"
            href="https://github.com/creativetimofficial/vue-wiblog-tools"
